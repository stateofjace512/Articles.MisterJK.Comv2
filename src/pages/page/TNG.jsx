          ...
          <div className="rounded-2xl border border-neutral-300 bg-gradient-to-b from-white to-neutral-100 shadow-[0_10px_30px_rgba(0,0,0,0.15)] ring-1 ring-black/5 p-6 md:p-10">
            ...
            <div className="text-center mb-8">
              ...
              <div className="max-w-md mx-auto">
                ...
                >
                  <option value="0">Article 1: Building an Album Over State and Country Lines</option>
                  <option value="1">Article 2: I Can't Find My Identity. Have YOU seen my identity?</option>
                  <option value="2">Article 3: I Don't Ask Anyone But Her</option>
                  <option value="3">Article 4: No Refunds, No Regrets</option>
                  <option value="4">Article 5: Sharin' Location, Sharin' Way Too Much</option>
                  <option value="5">Article 6: I Sat With That: When Silence Speaks Louder</option>
                  <option value="6">Article 7: Inside Voice: When Silence Breaks</option>
                  <option value="7">Article 8: The Accidental Lesbian Anthem</option>
                  <option value="8">Article 9: The Pettiest Closure Song We Ever Wrote</option>
                  <option value="9">Article 10: You Can't Top This (And Yes, We Knew What We Were Doing)</option>
                  <option value="10">Article 11: Girl Go Down</option>
                  <option value="11">Article 12: AFTERWORD</option>
                </select>
              </div>
            </div>
